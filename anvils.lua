...
local function damage_anvil(pos)
	...
	local new
	if node.name == "anvils:anvil" then
		minetest.swap_node(pos, {name="anvils:anvil_damage_1", param2=node.param2})
		minetest.sound_play(default.node_sound_metal_defaults().dig, {pos=pos, max_hear_distance=16})
		return false
	elseif node.name == "anvils:anvil_damage_1" then
		minetest.swap_node(pos, {name="anvils:anvil_damage_2", param2=node.param2})
		minetest.sound_play(default.node_sound_metal_defaults().dig, {pos=pos, max_hear_distance=16})
		return false
	elseif node.name == "anvils:anvil_damage_2" then
		-- Destroy anvil
		local meta = minetest.get_meta(pos)
		drop_anvil_items(pos, meta)
		minetest.sound_play(default.node_sound_metal_defaults().dug, {pos=pos, max_hear_distance=16})
...
local anvildef = {
	groups = {cracky = 1, level = 2, pickaxey=1, falling_node=1, falling_node_damage=1, crush_after_fall=1, deco_block=1, anvil=1},
	tiles = {"anvils_anvil_top_damaged_0.png^[transformR90", "anvils_anvil_base.png", "anvils_anvil_side.png"},
	paramtype = "light",
...
anvildef1._doc_items_create_entry = false
anvildef1.tiles = {"anvils_anvil_top_damaged_1.png^[transformR90", "anvils_anvil_base.png", "anvils_anvil_side.png"}
...
anvildef2._doc_items_create_entry = false
anvildef2.tiles = {"anvils_anvil_top_damaged_2.png^[transformR90", "anvils_anvil_base.png", "anvils_anvil_side.png"}

minetest.register_node("anvils:anvil", anvildef0)
minetest.register_node("anvils:anvil_damage_1", anvildef1)
minetest.register_node("anvils:anvil_damage_2", anvildef2)
